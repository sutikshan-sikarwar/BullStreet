...
public class OrderServiceImplementation implements OrderService{
    ...
    @Override
    public List<Order> getAllOrdersOfUsers(String userId, OrderType orderType, String assetSymbol) {
    ...
    public Order buyAsset(Coin coin, double quantity, User user) throws Exception {
        ...
        // create asset
        Asset oldAsset = assetService.findAssetByUserIdAndCoinId(order.getUser().getId(),orderItem.getCoin().getId());
        if (oldAsset==null){
